...
import Controller.DisplayEncheresController;
...
public class MiseController implements Initializable {
    ...
    public void setUserData(String data) {
                ...
                productName.setText(String.valueOf(selectedEnchere.getProduitName()));
                productPrice.setText(String.valueOf(selectedEnchere.getProduit()));
                ProductDesc.setText(String.valueOf(selectedEnchere.getCreateur()));
    ...
    private void addMise(MouseEvent event) {
        ...
        mise.setCreateur(userService.afficherUserbyID(1));
